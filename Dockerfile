...
# clone & install c9sdk
RUN sudo -u ubuntu -i bash -l -c "git  clone  https://github.com/smartfaceio/c9-core /home/ubuntu/c9sdk" && \
...
# clone workspace
RUN	sudo -u ubuntu -i bash -l -c "git clone https://github.com/SmartfaceIO/sample-kitchensink /home/ubuntu/workspace" && \
